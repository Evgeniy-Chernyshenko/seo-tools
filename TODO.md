...
- Посмотреть нужна ли ручка POST /api/v1/auth/logout, мб все в сессии перенести. И в сессиях тоже показать какие куки чистятся
- Экран ошибки
- Где лоадеры повесить спиннер
- Преименовать SEOTools в SEMTools
- Переделать ошибки бека на русские
- Переделать шаблон email
